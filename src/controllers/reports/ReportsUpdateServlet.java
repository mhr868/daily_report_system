...
public class ReportsUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(_token != null && _token.equals(request.getSession().getId())) {
			...
			Report r = em.find(Report.class, (Integer)(request.getSession().getAttribute("report_id_to_be_updated")));
			...
			if(errors.size() > 0) {
				...
				request.getSession().removeAttribute("report_id_to_be_updated");
